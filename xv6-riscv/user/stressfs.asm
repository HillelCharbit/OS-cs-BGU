...
gets(char *buf, int max)
{
 ...
 218:	1b0080e7          	jalr	432(ra) # 3c4 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 26a:	186080e7          	jalr	390(ra) # 3ec <open>
  if(fd < 0)
 ...
 27a:	18e080e7          	jalr	398(ra) # 404 <fstat>
 27e:	892a                	mv	s2,a0
  close(fd);
 280:	8526                	mv	a0,s1
 282:	00000097          	auipc	ra,0x0
 286:	152080e7          	jalr	338(ra) # 3d4 <close>
  return r;
}
 28a:	854a                	mv	a0,s2
