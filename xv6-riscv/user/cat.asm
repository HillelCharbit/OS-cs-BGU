...
cat(int fd)
{
  ...
  24:	3ae080e7          	jalr	942(ra) # 3ce <read>
  28:	84aa                	mv	s1,a0
  ...
  38:	3a2080e7          	jalr	930(ra) # 3d6 <write>
...
main(int argc, char *argv[])
{
  ...
  be:	33c080e7          	jalr	828(ra) # 3f6 <open>
  c2:	84aa                	mv	s1,a0
  ...
  d6:	30c080e7          	jalr	780(ra) # 3de <close>
  for(i = 1; i < argc; i++){
...
malloc(uint nbytes)
{
 ...
 8c4:	b7e080e7          	jalr	-1154(ra) # 43e <sbrk>
  if(p == (char*)-1)
