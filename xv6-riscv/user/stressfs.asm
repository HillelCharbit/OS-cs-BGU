...
main(int argc, char *argv[])
{
  ...
  8e:	35a080e7          	jalr	858(ra) # 3e4 <open>
  92:	892a                	mv	s2,a0
  94:	44d1                	li	s1,20
  for(i = 0; i < 20; i++)
//    printf(fd, "%d\n", i);
  ...
  a4:	324080e7          	jalr	804(ra) # 3c4 <write>
  for(i = 0; i < 20; i++)
  ...
  b2:	31e080e7          	jalr	798(ra) # 3cc <close>
  ...
  d0:	318080e7          	jalr	792(ra) # 3e4 <open>
  d4:	892a                	mv	s2,a0
  d6:	44d1                	li	s1,20
  for (i = 0; i < 20; i++)
  ...
  e6:	2da080e7          	jalr	730(ra) # 3bc <read>
  for (i = 0; i < 20; i++)
  ...
  f4:	2dc080e7          	jalr	732(ra) # 3cc <close>
...
gets(char *buf, int max)
{
 ...
 218:	1a8080e7          	jalr	424(ra) # 3bc <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 26a:	17e080e7          	jalr	382(ra) # 3e4 <open>
  if(fd < 0)
 ...
 27a:	186080e7          	jalr	390(ra) # 3fc <fstat>
 27e:	892a                	mv	s2,a0
  close(fd);
 280:	8526                	mv	a0,s1
 282:	00000097          	auipc	ra,0x0
 286:	14a080e7          	jalr	330(ra) # 3cc <close>
  return r;
}
 28a:	854a                	mv	a0,s2
