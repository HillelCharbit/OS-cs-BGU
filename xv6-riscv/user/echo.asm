...
gets(char *buf, int max)
{
 ...
 190:	1b0080e7          	jalr	432(ra) # 33c <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1e2:	186080e7          	jalr	390(ra) # 364 <open>
  if(fd < 0)
 ...
 1f2:	18e080e7          	jalr	398(ra) # 37c <fstat>
 1f6:	892a                	mv	s2,a0
  close(fd);
 1f8:	8526                	mv	a0,s1
 1fa:	00000097          	auipc	ra,0x0
 1fe:	152080e7          	jalr	338(ra) # 34c <close>
  return r;
}
 202:	854a                	mv	a0,s2
...
putc(int fd, char c)
{
 ...
 3da:	f6e080e7          	jalr	-146(ra) # 344 <write>
}
...
malloc(uint nbytes)
{
 ...
 832:	b7e080e7          	jalr	-1154(ra) # 3ac <sbrk>
  if(p == (char*)-1)
