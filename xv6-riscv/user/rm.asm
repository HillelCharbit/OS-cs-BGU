...
main(int argc, char *argv[])
{
  ...
  2e:	336080e7          	jalr	822(ra) # 360 <unlink>
...
gets(char *buf, int max)
{
 ...
 184:	1a8080e7          	jalr	424(ra) # 328 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1d6:	17e080e7          	jalr	382(ra) # 350 <open>
  if(fd < 0)
 ...
 1e6:	186080e7          	jalr	390(ra) # 368 <fstat>
 1ea:	892a                	mv	s2,a0
  close(fd);
 1ec:	8526                	mv	a0,s1
 1ee:	00000097          	auipc	ra,0x0
 1f2:	14a080e7          	jalr	330(ra) # 338 <close>
  return r;
}
 1f6:	854a                	mv	a0,s2
