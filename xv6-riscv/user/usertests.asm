...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open((char *)addr, O_CREATE|O_WRONLY);
      ...
      14:	c08080e7          	jalr	-1016(ra) # 5c18 <open>
    if(fd >= 0){
    ...
    int fd = open((char *)addr, O_CREATE|O_WRONLY);
      ...
      26:	bf6080e7          	jalr	-1034(ra) # 5c18 <open>
    uint64 addr = addrs[ai];
      2a:	55fd                	li	a1,-1
    if(fd >= 0){
...
000000000000011c <truncate2>:
{
  ...
  int n = write(fd1, "x", 1);
     ...
     18a:	a72080e7          	jalr	-1422(ra) # 5bf8 <write>
  if(n != -1){
     18e:	57fd                	li	a5,-1
  ...
  unlink("truncfile");
     ...
     1a0:	a8c080e7          	jalr	-1396(ra) # 5c28 <unlink>
  close(fd1);
     1a4:	8526                	mv	a0,s1
     1a6:	00006097          	auipc	ra,0x6
     1aa:	a5a080e7          	jalr	-1446(ra) # 5c00 <close>
  close(fd2);
     1ae:	854a                	mv	a0,s2
     1b0:	00006097          	auipc	ra,0x6
     1b4:	a50080e7          	jalr	-1456(ra) # 5c00 <close>
}
...
00000000000001e4 <createtest>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    fd = open(name, O_CREATE|O_RDWR);
     ...
     214:	a08080e7          	jalr	-1528(ra) # 5c18 <open>
    close(fd);
     218:	00006097          	auipc	ra,0x6
     21c:	9e8080e7          	jalr	-1560(ra) # 5c00 <close>
  for(i = 0; i < N; i++){
  ...
  for(i = 0; i < N; i++){
    ...
    unlink(name);
     ...
     24a:	9e2080e7          	jalr	-1566(ra) # 5c28 <unlink>
  for(i = 0; i < N; i++){
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     288:	9a4080e7          	jalr	-1628(ra) # 5c28 <unlink>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     2b0:	96c080e7          	jalr	-1684(ra) # 5c18 <open>
     2b4:	892a                	mv	s2,a0
    if(fd < 0){
     ...
     2c2:	93a080e7          	jalr	-1734(ra) # 5bf8 <write>
     2c6:	89aa                	mv	s3,a0
      if(cc != sz){
     ...
     2d6:	926080e7          	jalr	-1754(ra) # 5bf8 <write>
      if(cc != sz){
     2da:	04951963          	bne	a0,s1,32c <bigwrite+0xc8>
    close(fd);
     2de:	854a                	mv	a0,s2
     2e0:	00006097          	auipc	ra,0x6
     2e4:	920080e7          	jalr	-1760(ra) # 5c00 <close>
    unlink("bigwrite");
     2e8:	8556                	mv	a0,s5
     2ea:	00006097          	auipc	ra,0x6
     2ee:	93e080e7          	jalr	-1730(ra) # 5c28 <unlink>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     36c:	8c0080e7          	jalr	-1856(ra) # 5c28 <unlink>
  ...
  for(int i = 0; i < assumed_free; i++){
    ...
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     38c:	890080e7          	jalr	-1904(ra) # 5c18 <open>
     390:	84aa                	mv	s1,a0
    if(fd < 0){
    ...
    write(fd, (char*)0xffffffffffL, 1);
     ...
     39e:	85e080e7          	jalr	-1954(ra) # 5bf8 <write>
    close(fd);
     3a2:	8526                	mv	a0,s1
     3a4:	00006097          	auipc	ra,0x6
     3a8:	85c080e7          	jalr	-1956(ra) # 5c00 <close>
    unlink("junk");
     3ac:	854e                	mv	a0,s3
     3ae:	00006097          	auipc	ra,0x6
     3b2:	87a080e7          	jalr	-1926(ra) # 5c28 <unlink>
  for(int i = 0; i < assumed_free; i++){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     3cc:	850080e7          	jalr	-1968(ra) # 5c18 <open>
     3d0:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(write(fd, "x", 1) != 1){
     ...
     3e4:	818080e7          	jalr	-2024(ra) # 5bf8 <write>
     3e8:	4785                	li	a5,1
...
outofinodes(char *s)
{
  ...
  for(int i = 0; i < nzz; i++){
    ...
    close(fd);
     ...
     4cc:	738080e7          	jalr	1848(ra) # 5c00 <close>
  for(int i = 0; i < nzz; i++){
  ...
  for(int i = 0; i < nzz; i++){
    ...
    unlink(name);
     ...
     518:	714080e7          	jalr	1812(ra) # 5c28 <unlink>
  for(int i = 0; i < nzz; i++){
...
0000000000000530 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     568:	6b4080e7          	jalr	1716(ra) # 5c18 <open>
     56c:	84aa                	mv	s1,a0
    if(fd < 0){
...
000000000000068c <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6cc:	550080e7          	jalr	1360(ra) # 5c18 <open>
     6d0:	84aa                	mv	s1,a0
    if(fd < 0){
    ...
    n = write(fds[1], "x", 1);
     ...
     70c:	4f0080e7          	jalr	1264(ra) # 5bf8 <write>
    if(n != 1){
     710:	4785                	li	a5,1
...
00000000000007e8 <truncate1>:
{
  ...
  unlink("truncfile");
     ...
     808:	424080e7          	jalr	1060(ra) # 5c28 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
     ...
     81c:	400080e7          	jalr	1024(ra) # 5c18 <open>
     820:	84aa                	mv	s1,a0
  write(fd1, "abcd", 4);
     822:	4611                	li	a2,4
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     878:	3a4080e7          	jalr	932(ra) # 5c18 <open>
     87c:	89aa                	mv	s3,a0
  ...
  n = read(fd2, buf, sizeof(buf));
     ...
     8b4:	340080e7          	jalr	832(ra) # 5bf0 <read>
     8b8:	8a2a                	mv	s4,a0
  if(n != 0){
  ...
  n = read(fd2, buf, sizeof(buf));
     ...
     8f6:	2fe080e7          	jalr	766(ra) # 5bf0 <read>
  if(n != 2){
     8fa:	4789                	li	a5,2
  ...
  unlink("truncfile");
     ...
     90c:	320080e7          	jalr	800(ra) # 5c28 <unlink>
  close(fd1);
     910:	854e                	mv	a0,s3
     912:	00005097          	auipc	ra,0x5
     916:	2ee080e7          	jalr	750(ra) # 5c00 <close>
  close(fd2);
     91a:	8526                	mv	a0,s1
     91c:	00005097          	auipc	ra,0x5
     920:	2e4080e7          	jalr	740(ra) # 5c00 <close>
  close(fd3);
     924:	854a                	mv	a0,s2
     926:	00005097          	auipc	ra,0x5
     92a:	2da080e7          	jalr	730(ra) # 5c00 <close>
}
...
00000000000009fa <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a20:	1fc080e7          	jalr	508(ra) # 5c18 <open>
  if(fd < 0){
  ...
  for(i = 0; i < N; i++){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a4a:	1b2080e7          	jalr	434(ra) # 5bf8 <write>
     a4e:	47a9                	li	a5,10
    ...
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     ...
     a5e:	19e080e7          	jalr	414(ra) # 5bf8 <write>
     a62:	47a9                	li	a5,10
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     aa0:	154080e7          	jalr	340(ra) # 5bf0 <read>
  if(i != N*SZ*2){
...
0000000000000b8a <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     bae:	06e080e7          	jalr	110(ra) # 5c18 <open>
     bb2:	89aa                	mv	s3,a0
  for(i = 0; i < MAXFILE; i++){
     bb4:	4481                	li	s1,0
    ((int*)buf)[0] = i;
  ...
  if(fd < 0){
    ...
    if(write(fd, buf, BSIZE) != BSIZE){
     ...
     bd6:	026080e7          	jalr	38(ra) # 5bf8 <write>
  ...
  if(fd < 0){
    ...
    i = read(fd, buf, BSIZE);
     ...
     c20:	fd4080e7          	jalr	-44(ra) # 5bf0 <read>
    if(i == 0){
...
0000000000000d40 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d60:	ebc080e7          	jalr	-324(ra) # 5c18 <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
     ...
     daa:	e82080e7          	jalr	-382(ra) # 5c28 <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     dc0:	e5c080e7          	jalr	-420(ra) # 5c18 <open>
     dc4:	892a                	mv	s2,a0
  write(fd1, "yyy", 3);
     dc6:	460d                	li	a2,3
     ...
     dd4:	e28080e7          	jalr	-472(ra) # 5bf8 <write>
  close(fd1);
     dd8:	854a                	mv	a0,s2
     dda:	00005097          	auipc	ra,0x5
     dde:	e26080e7          	jalr	-474(ra) # 5c00 <close>
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     df2:	e02080e7          	jalr	-510(ra) # 5bf0 <read>
     df6:	4795                	li	a5,5
...
0000000000000ef6 <linktest>:
{
  ...
  fd = open("lf1", O_CREATE|O_RDWR);
     ...
     f34:	ce8080e7          	jalr	-792(ra) # 5c18 <open>
  if(fd < 0){
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f4c:	cb0080e7          	jalr	-848(ra) # 5bf8 <write>
     f50:	4795                	li	a5,5
     f52:	10f51863          	bne	a0,a5,1062 <linktest+0x16c>
  close(fd);
     f56:	8526                	mv	a0,s1
     f58:	00005097          	auipc	ra,0x5
     f5c:	ca8080e7          	jalr	-856(ra) # 5c00 <close>
  if(link("lf1", "lf2") < 0){
     ...
     f74:	cc8080e7          	jalr	-824(ra) # 5c38 <link>
  ...
  fd = open("lf2", 0);
     ...
     fb0:	c6c080e7          	jalr	-916(ra) # 5c18 <open>
     fb4:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  unlink("lf2");
     ...
     ffe:	c2e080e7          	jalr	-978(ra) # 5c28 <unlink>
  if(link("lf2", "lf1") >= 0){
    ...
    1016:	c26080e7          	jalr	-986(ra) # 5c38 <link>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1032:	c0a080e7          	jalr	-1014(ra) # 5c38 <link>
...
0000000000001142 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1172:	aca080e7          	jalr	-1334(ra) # 5c38 <link>
...
00000000000011b0 <bigdir>:
{
  ...
  unlink("bd");
    ...
    11d2:	a5a080e7          	jalr	-1446(ra) # 5c28 <unlink>
  fd = open("bd", O_CREATE);
    ...
    11e6:	a36080e7          	jalr	-1482(ra) # 5c18 <open>
  if(fd < 0){
    11ea:	0c054963          	bltz	a0,12bc <bigdir+0x10c>
  close(fd);
    11ee:	00005097          	auipc	ra,0x5
    11f2:	a12080e7          	jalr	-1518(ra) # 5c00 <close>
  for(i = 0; i < N; i++){
    11f6:	4901                	li	s2,0
    name[0] = 'x';
  ...
  for(i = 0; i < N; i++){
    ...
    1240:	9fc080e7          	jalr	-1540(ra) # 5c38 <link>
    1244:	84aa                	mv	s1,a0
  ...
  unlink("bd");
    ...
    125a:	9d2080e7          	jalr	-1582(ra) # 5c28 <unlink>
    name[0] = 'x';
  ...
  for(i = 0; i < N; i++){
    ...
    129c:	990080e7          	jalr	-1648(ra) # 5c28 <unlink>
...
0000000000001314 <pgbug>:
{
  ...
  exec(big, argv);
    ...
    1334:	8e0080e7          	jalr	-1824(ra) # 5c10 <exec>
  pipe(big);
    1338:	6088                	ld	a0,0(s1)
    133a:	00005097          	auipc	ra,0x5
    133e:	8ae080e7          	jalr	-1874(ra) # 5be8 <pipe>
  exit(0);
    1342:	4501                	li	a0,0
...
000000000000134c <badarg>:
{
    ...
    1380:	894080e7          	jalr	-1900(ra) # 5c10 <exec>
...
0000000000001392 <copyinstr2>:
{
  ...
  int ret = unlink(b);
    ...
    13bc:	870080e7          	jalr	-1936(ra) # 5c28 <unlink>
  if(ret != -1){
    13c0:	57fd                	li	a5,-1
  ...
  int fd = open(b, O_CREATE | O_WRONLY);
    ...
    13d2:	84a080e7          	jalr	-1974(ra) # 5c18 <open>
  if(fd != -1){
    13d6:	57fd                	li	a5,-1
  ...
  ret = link(b, b);
    ...
    13e6:	856080e7          	jalr	-1962(ra) # 5c38 <link>
  if(ret != -1){
    13ea:	57fd                	li	a5,-1
  ...
  ret = exec(b, args);
    ...
    140c:	808080e7          	jalr	-2040(ra) # 5c10 <exec>
  if(ret != -1){
    1410:	57fd                	li	a5,-1
  ...
  if(pid == 0){
    ...
    147c:	798080e7          	jalr	1944(ra) # 5c10 <exec>
    if(ret != -1){
    1480:	57fd                	li	a5,-1
...
0000000000001588 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    15ac:	670080e7          	jalr	1648(ra) # 5c18 <open>
    15b0:	00004097          	auipc	ra,0x4
    15b4:	650080e7          	jalr	1616(ra) # 5c00 <close>
  pid = fork();
  ...
  if(pid == 0){
    ...
    15e2:	63a080e7          	jalr	1594(ra) # 5c18 <open>
    15e6:	84aa                	mv	s1,a0
      if(fd < 0){
    ...
    15f4:	608080e7          	jalr	1544(ra) # 5bf8 <write>
      if(n != 10){
    15f8:	47a9                	li	a5,10
    ...
    1604:	600080e7          	jalr	1536(ra) # 5c00 <close>
      fd = open("truncfile", O_RDONLY);
    1608:	4581                	li	a1,0
    160a:	8552                	mv	a0,s4
    160c:	00004097          	auipc	ra,0x4
    1610:	60c080e7          	jalr	1548(ra) # 5c18 <open>
    1614:	84aa                	mv	s1,a0
      read(fd, buf, sizeof(buf));
    1616:	02000613          	li	a2,32
    161a:	f9840593          	addi	a1,s0,-104
    161e:	00004097          	auipc	ra,0x4
    1622:	5d2080e7          	jalr	1490(ra) # 5bf0 <read>
      close(fd);
    1626:	8526                	mv	a0,s1
    1628:	00004097          	auipc	ra,0x4
    162c:	5d8080e7          	jalr	1496(ra) # 5c00 <close>
    for(int i = 0; i < 100; i++){
    ...
    16b4:	568080e7          	jalr	1384(ra) # 5c18 <open>
    16b8:	84aa                	mv	s1,a0
    if(fd < 0){
    ...
    16c6:	536080e7          	jalr	1334(ra) # 5bf8 <write>
    if(n != 3){
    16ca:	478d                	li	a5,3
    ...
    16d6:	52e080e7          	jalr	1326(ra) # 5c00 <close>
  for(int i = 0; i < 150; i++){
  ...
  unlink("truncfile");
    ...
    16f8:	534080e7          	jalr	1332(ra) # 5c28 <unlink>
  exit(xstatus);
...
0000000000001742 <exectest>:
{
  ...
  unlink("echo-ok");
    ...
    1778:	4b4080e7          	jalr	1204(ra) # 5c28 <unlink>
  pid = fork();
  ...
  if(pid == 0) {
    ...
    1792:	472080e7          	jalr	1138(ra) # 5c00 <close>
    ...
    17a6:	476080e7          	jalr	1142(ra) # 5c18 <open>
    if(fd < 0) {
    ...
    1818:	3fc080e7          	jalr	1020(ra) # 5c10 <exec>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    187c:	3a0080e7          	jalr	928(ra) # 5c18 <open>
  if(fd < 0) {
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    188e:	366080e7          	jalr	870(ra) # 5bf0 <read>
    1892:	4789                	li	a5,2
  ...
  unlink("echo-ok");
    ...
    18dc:	350080e7          	jalr	848(ra) # 5c28 <unlink>
  if(buf[0] == 'O' && buf[1] == 'K')
...
000000000000191e <pipe1>:
{
  ...
  if(pipe(fds) != 0){
    ...
    193e:	2ae080e7          	jalr	686(ra) # 5be8 <pipe>
  ...
  if(pid == 0){
    ...
    195e:	2a6080e7          	jalr	678(ra) # 5c00 <close>
    total = 0;
    1962:	8a26                	mv	s4,s1
    cc = 1;
    1964:	4985                	li	s3,1
    ...
    197c:	278080e7          	jalr	632(ra) # 5bf0 <read>
    ...
    19de:	226080e7          	jalr	550(ra) # 5c00 <close>
    for(n = 0; n < N; n++){
    ...
    19fa:	42da8a93          	addi	s5,s5,1069 # 142d <copyinstr2+0x9b>
{
    ...
    1a20:	1dc080e7          	jalr	476(ra) # 5bf8 <write>
    ...
    1ab2:	152080e7          	jalr	338(ra) # 5c00 <close>
    wait(&xstatus);
...
0000000000001d6a <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1e34:	de8080e7          	jalr	-536(ra) # 5c18 <open>
        if(fd < 0){
    1e38:	fc0543e3          	bltz	a0,1dfe <createdelete+0x94>
        close(fd);
    1e3c:	00004097          	auipc	ra,0x4
    1e40:	dc4080e7          	jalr	-572(ra) # 5c00 <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    1e68:	dc4080e7          	jalr	-572(ra) # 5c28 <unlink>
    ...
    1ee4:	d38080e7          	jalr	-712(ra) # 5c18 <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    1efc:	d08080e7          	jalr	-760(ra) # 5c00 <close>
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1f5c:	cd0080e7          	jalr	-816(ra) # 5c28 <unlink>
    for(pi = 0; pi < NCHILD; pi++){
...
0000000000001f90 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fb8:	c74080e7          	jalr	-908(ra) # 5c28 <unlink>
  pid = fork();
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    2020:	bfc080e7          	jalr	-1028(ra) # 5c18 <open>
    2024:	00004097          	auipc	ra,0x4
    2028:	bdc080e7          	jalr	-1060(ra) # 5c00 <close>
    202c:	a031                	j	2038 <linkunlink+0xa8>
      unlink("x");
    202e:	8556                	mv	a0,s5
    2030:	00004097          	auipc	ra,0x4
    2034:	bf8080e7          	jalr	-1032(ra) # 5c28 <unlink>
  for(i = 0; i < 100; i++){
    ...
    205a:	be2080e7          	jalr	-1054(ra) # 5c38 <link>
...
00000000000022cc <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    22e4:	948080e7          	jalr	-1720(ra) # 5c28 <unlink>
  pid = fork();
  ...
  fd = open("bigarg-ok", 0);
    ...
    2316:	906080e7          	jalr	-1786(ra) # 5c18 <open>
  if(fd < 0){
    231a:	08054e63          	bltz	a0,23b6 <bigargtest+0xea>
  close(fd);
    231e:	00004097          	auipc	ra,0x4
    2322:	8e2080e7          	jalr	-1822(ra) # 5c00 <close>
}
    ...
    2368:	8ac080e7          	jalr	-1876(ra) # 5c10 <exec>
    ...
    237c:	8a0080e7          	jalr	-1888(ra) # 5c18 <open>
    close(fd);
    2380:	00004097          	auipc	ra,0x4
    2384:	880080e7          	jalr	-1920(ra) # 5c00 <close>
    exit(0);
    2388:	4501                	li	a0,0
...
00000000000024c4 <manywrites>:
{
  ...
  exit(0);
    ...
    2552:	6da080e7          	jalr	1754(ra) # 5c28 <unlink>
    2556:	4b79                	li	s6,30
          int cc = write(fd, buf, sz);
    ...
    2572:	6aa080e7          	jalr	1706(ra) # 5c18 <open>
    2576:	89aa                	mv	s3,a0
          if(fd < 0){
    ...
    2584:	678080e7          	jalr	1656(ra) # 5bf8 <write>
          if(cc != sz){
    ...
    2594:	670080e7          	jalr	1648(ra) # 5c00 <close>
        for(int i = 0; i < ci+1; i++){
    ...
    25a6:	686080e7          	jalr	1670(ra) # 5c28 <unlink>
    ...
    25b8:	674080e7          	jalr	1652(ra) # 5c28 <unlink>
      exit(0);
    25bc:	4501                	li	a0,0
...
000000000000260e <copyinstr3>:
{
  ...
  sbrk(8192);
    ...
    261e:	646080e7          	jalr	1606(ra) # 5c60 <sbrk>
  uint64 top = (uint64) sbrk(0);
    2622:	4501                	li	a0,0
    2624:	00003097          	auipc	ra,0x3
    2628:	63c080e7          	jalr	1596(ra) # 5c60 <sbrk>
  if((top % PGSIZE) != 0){
  ...
  top = (uint64) sbrk(0);
    ...
    2638:	62c080e7          	jalr	1580(ra) # 5c60 <sbrk>
  if(top % PGSIZE){
  ...
  *b = 'x';
  ...
  int ret = unlink(b);
    ...
    2654:	5d8080e7          	jalr	1496(ra) # 5c28 <unlink>
  if(ret != -1){
    2658:	57fd                	li	a5,-1
  ...
  int fd = open(b, O_CREATE | O_WRONLY);
    ...
    2668:	5b4080e7          	jalr	1460(ra) # 5c18 <open>
  if(fd != -1){
    266c:	57fd                	li	a5,-1
  ...
  ret = link(b, b);
    ...
    267a:	5c2080e7          	jalr	1474(ra) # 5c38 <link>
  if(ret != -1){
    267e:	57fd                	li	a5,-1
  ...
  ret = exec(b, args);
    ...
    269e:	576080e7          	jalr	1398(ra) # 5c10 <exec>
  if(ret != -1){
    26a2:	57fd                	li	a5,-1
    ...
    26c0:	5a4080e7          	jalr	1444(ra) # 5c60 <sbrk>
...
000000000000275a <rwsbrk>:
{
  ...
  uint64 a = (uint64) sbrk(8192);
    ...
    276c:	4f8080e7          	jalr	1272(ra) # 5c60 <sbrk>
  ...
  if ((uint64) sbrk(-8192) ==  0xffffffffffffffffLL) {
    ...
    277e:	4e6080e7          	jalr	1254(ra) # 5c60 <sbrk>
    2782:	57fd                	li	a5,-1
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    2798:	484080e7          	jalr	1156(ra) # 5c18 <open>
    279c:	892a                	mv	s2,a0
  if(fd < 0){
  ...
  n = write(fd, (void*)(a+4096), 1024);
    ...
    27b2:	44a080e7          	jalr	1098(ra) # 5bf8 <write>
    27b6:	862a                	mv	a2,a0
  if(n >= 0){
  ...
  n = read(fd, (void*)(a+4096), 10);
    ...
    2860:	394080e7          	jalr	916(ra) # 5bf0 <read>
    2864:	862a                	mv	a2,a0
  if(n >= 0){
  ...
  close(fd);
    ...
    28a6:	35e080e7          	jalr	862(ra) # 5c00 <close>
  exit(0);
    28aa:	4501                	li	a0,0
...
00000000000028b4 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    28de:	386080e7          	jalr	902(ra) # 5c60 <sbrk>
  ...
  a = sbrk(0);
    ...
    2948:	31c080e7          	jalr	796(ra) # 5c60 <sbrk>
    294c:	84aa                	mv	s1,a0
  for(i = 0; i < 5000; i++){
    294e:	4901                	li	s2,0
    *b = 1;
  ...
  for(i = 0; i < 5000; i++){
    ...
    297e:	2e6080e7          	jalr	742(ra) # 5c60 <sbrk>
    if(b != a){
  ...
  c = sbrk(1);
    ...
    29a8:	2bc080e7          	jalr	700(ra) # 5c60 <sbrk>
  c = sbrk(1);
    29ac:	4505                	li	a0,1
    29ae:	00003097          	auipc	ra,0x3
    29b2:	2b2080e7          	jalr	690(ra) # 5c60 <sbrk>
  if(c != a + 1){
...
0000000000002a3c <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    ...
    2aa8:	1bc080e7          	jalr	444(ra) # 5c60 <sbrk>
    2aac:	84aa                	mv	s1,a0
  c = sbrk(-PGSIZE);
    2aae:	757d                	lui	a0,0xfffff
    2ab0:	00003097          	auipc	ra,0x3
    2ab4:	1b0080e7          	jalr	432(ra) # 5c60 <sbrk>
  ...
  c = sbrk(0);
    ...
    2ac4:	1a0080e7          	jalr	416(ra) # 5c60 <sbrk>
  if(c != a - PGSIZE){
  ...
  a = sbrk(0);
    ...
    2b14:	150080e7          	jalr	336(ra) # 5c60 <sbrk>
    2b18:	84aa                	mv	s1,a0
  c = sbrk(-(sbrk(0) - oldbrk));
    2b1a:	4501                	li	a0,0
    2b1c:	00003097          	auipc	ra,0x3
    2b20:	144080e7          	jalr	324(ra) # 5c60 <sbrk>
    2b24:	40a9053b          	subw	a0,s2,a0
    2b28:	00003097          	auipc	ra,0x3
    2b2c:	138080e7          	jalr	312(ra) # 5c60 <sbrk>
  if(c != a){
...
0000000000002bf8 <sbrkarg>:
{
  ...
  a = sbrk(PGSIZE);
    ...
    2c0e:	056080e7          	jalr	86(ra) # 5c60 <sbrk>
    2c12:	892a                	mv	s2,a0
  ...
  if ((n = write(fd, a, PGSIZE)) < 0) {
    ...
    2c48:	fb4080e7          	jalr	-76(ra) # 5bf8 <write>
    2c4c:	04054663          	bltz	a0,2c98 <sbrkarg+0xa0>
  close(fd);
    2c50:	8526                	mv	a0,s1
    2c52:	00003097          	auipc	ra,0x3
    2c56:	fae080e7          	jalr	-82(ra) # 5c00 <close>
  a = sbrk(PGSIZE);
    2c5a:	6505                	lui	a0,0x1
    2c5c:	00003097          	auipc	ra,0x3
    2c60:	004080e7          	jalr	4(ra) # 5c60 <sbrk>
  if(pipe((int *) a) != 0){
    2c64:	00003097          	auipc	ra,0x3
    2c68:	f84080e7          	jalr	-124(ra) # 5be8 <pipe>
...
0000000000002cd0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2cec:	f30080e7          	jalr	-208(ra) # 5c18 <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    2cfc:	f68080e7          	jalr	-152(ra) # 5c60 <sbrk>
    2d00:	567d                	li	a2,-1
    2d02:	fff50593          	addi	a1,a0,-1
    2d06:	8526                	mv	a0,s1
    2d08:	00003097          	auipc	ra,0x3
    2d0c:	ee8080e7          	jalr	-280(ra) # 5bf0 <read>
  close(fd);
    2d10:	8526                	mv	a0,s1
    2d12:	00003097          	auipc	ra,0x3
    2d16:	eee080e7          	jalr	-274(ra) # 5c00 <close>
}
...
0000000000002d42 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2d5c:	f08080e7          	jalr	-248(ra) # 5c60 <sbrk>
    sbrk(-sz);
    2d60:	40a0053b          	negw	a0,a0
    2d64:	00003097          	auipc	ra,0x3
    2d68:	efc080e7          	jalr	-260(ra) # 5c60 <sbrk>
    exit(0);
    2d6c:	4501                	li	a0,0
...
0000000000002e5a <sbrklast>:
{
  ...
  uint64 top = (uint64) sbrk(0);
    ...
    2e6e:	df6080e7          	jalr	-522(ra) # 5c60 <sbrk>
  if((top % 4096) != 0)
  ...
  sbrk(4096);
    ...
    2e7e:	de6080e7          	jalr	-538(ra) # 5c60 <sbrk>
  sbrk(10);
    2e82:	4529                	li	a0,10
    2e84:	00003097          	auipc	ra,0x3
    2e88:	ddc080e7          	jalr	-548(ra) # 5c60 <sbrk>
  sbrk(-20);
    2e8c:	5531                	li	a0,-20
    2e8e:	00003097          	auipc	ra,0x3
    2e92:	dd2080e7          	jalr	-558(ra) # 5c60 <sbrk>
  top = (uint64) sbrk(0);
    2e96:	4501                	li	a0,0
    2e98:	00003097          	auipc	ra,0x3
    2e9c:	dc8080e7          	jalr	-568(ra) # 5c60 <sbrk>
    2ea0:	84aa                	mv	s1,a0
  char *p = (char *) (top - 64);
  ...
  int fd = open(p, O_RDWR|O_CREATE);
    ...
    2ebc:	d60080e7          	jalr	-672(ra) # 5c18 <open>
    2ec0:	89aa                	mv	s3,a0
  write(fd, p, 1);
    2ec2:	4605                	li	a2,1
    2ec4:	85ca                	mv	a1,s2
    2ec6:	00003097          	auipc	ra,0x3
    2eca:	d32080e7          	jalr	-718(ra) # 5bf8 <write>
  close(fd);
    2ece:	854e                	mv	a0,s3
    2ed0:	00003097          	auipc	ra,0x3
    2ed4:	d30080e7          	jalr	-720(ra) # 5c00 <close>
  fd = open(p, O_RDWR);
    2ed8:	4589                	li	a1,2
    2eda:	854a                	mv	a0,s2
    2edc:	00003097          	auipc	ra,0x3
    2ee0:	d3c080e7          	jalr	-708(ra) # 5c18 <open>
  p[0] = '\0';
  ...
  read(fd, p, 1);
    ...
    2ef0:	d04080e7          	jalr	-764(ra) # 5bf0 <read>
  if(p[0] != 'x')
    ...
    2f1c:	d48080e7          	jalr	-696(ra) # 5c60 <sbrk>
...
0000000000002f2c <sbrk8000>:
{
  ...
  sbrk(0x80000004);
    ...
    2f3e:	d26080e7          	jalr	-730(ra) # 5c60 <sbrk>
  volatile char *top = sbrk(0);
    2f42:	4501                	li	a0,0
    2f44:	00003097          	auipc	ra,0x3
    2f48:	d1c080e7          	jalr	-740(ra) # 5c60 <sbrk>
  *(top-1) = *(top-1) + 1;
...
0000000000002f62 <execout>:
{
  ...
  exit(0);
    ...
    2fc4:	ca0080e7          	jalr	-864(ra) # 5c60 <sbrk>
        if(a == 0xffffffffffffffffLL)
    ...
    2fe0:	c84080e7          	jalr	-892(ra) # 5c60 <sbrk>
      for(int i = 0; i < avail; i++)
    ...
    2ff0:	c14080e7          	jalr	-1004(ra) # 5c00 <close>
      char *args[] = { "echo", "x", 0 };
    ...
    3018:	bfc080e7          	jalr	-1028(ra) # 5c10 <exec>
      exit(0);
    301c:	4501                	li	a0,0
...
0000000000003026 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    303e:	c06080e7          	jalr	-1018(ra) # 5c40 <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    3050:	bf4080e7          	jalr	-1036(ra) # 5c40 <mkdir>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    30b2:	b92080e7          	jalr	-1134(ra) # 5c40 <mkdir>
...
00000000000031ca <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    3208:	a24080e7          	jalr	-1500(ra) # 5c28 <unlink>
  for(fi = 0; done == 0; fi++){
    320c:	4a01                	li	s4,0
    name[0] = 'b';
    ...
    323e:	9c6080e7          	jalr	-1594(ra) # 5c00 <close>
    close(fd);
    3242:	854a                	mv	a0,s2
    3244:	00003097          	auipc	ra,0x3
    3248:	9bc080e7          	jalr	-1604(ra) # 5c00 <close>
  for(fi = 0; done == 0; fi++){
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    32c2:	982080e7          	jalr	-1662(ra) # 5c40 <mkdir>
  ...
  unlink("diskfulldir");
    ...
    32d6:	956080e7          	jalr	-1706(ra) # 5c28 <unlink>
  for(int i = 0; i < nzz; i++){
    32da:	4481                	li	s1,0
    name[0] = 'z';
  ...
  for(int i = 0; i < nzz; i++){
    ...
    331c:	910080e7          	jalr	-1776(ra) # 5c28 <unlink>
  for(int i = 0; i < nzz; i++){
  ...
  for(int i = 0; i < fi; i++){
    ...
    3358:	8d4080e7          	jalr	-1836(ra) # 5c28 <unlink>
  for(int i = 0; i < fi; i++){
    ...
    3396:	86e080e7          	jalr	-1938(ra) # 5c00 <close>
  for(fi = 0; done == 0; fi++){
    ...
    33e6:	816080e7          	jalr	-2026(ra) # 5bf8 <write>
...
000000000000340a <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    3422:	822080e7          	jalr	-2014(ra) # 5c40 <mkdir>
  ...
  if(chdir("iputdir") < 0){
    ...
    3436:	816080e7          	jalr	-2026(ra) # 5c48 <chdir>
  ...
  if(unlink("../iputdir") < 0){
    ...
    344a:	7e2080e7          	jalr	2018(ra) # 5c28 <unlink>
  ...
  if(chdir("/") < 0){
    ...
    345e:	7ee080e7          	jalr	2030(ra) # 5c48 <chdir>
...
00000000000034e0 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    3506:	73e080e7          	jalr	1854(ra) # 5c40 <mkdir>
    ...
    351a:	732080e7          	jalr	1842(ra) # 5c48 <chdir>
    ...
    352e:	6fe080e7          	jalr	1790(ra) # 5c28 <unlink>
...
00000000000035c8 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    35e0:	664080e7          	jalr	1636(ra) # 5c40 <mkdir>
  ...
  if(chdir("dir0") < 0){
    ...
    35f4:	658080e7          	jalr	1624(ra) # 5c48 <chdir>
  ...
  if(chdir("..") < 0){
    ...
    3608:	644080e7          	jalr	1604(ra) # 5c48 <chdir>
  ...
  if(unlink("dir0") < 0){
    ...
    361c:	610080e7          	jalr	1552(ra) # 5c28 <unlink>
...
000000000000369e <subdir>:
{
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    36e0:	53c080e7          	jalr	1340(ra) # 5c18 <open>
    36e4:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3726:	51e080e7          	jalr	1310(ra) # 5c40 <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    373e:	4de080e7          	jalr	1246(ra) # 5c18 <open>
    3742:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    378a:	46a080e7          	jalr	1130(ra) # 5bf0 <read>
  if(cc != 2 || buf[0] != 'f'){
    378e:	4789                	li	a5,2
  ...
  close(fd);
    ...
    37aa:	45a080e7          	jalr	1114(ra) # 5c00 <close>
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    37c2:	47a080e7          	jalr	1146(ra) # 5c38 <link>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    37d6:	456080e7          	jalr	1110(ra) # 5c28 <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    37ec:	430080e7          	jalr	1072(ra) # 5c18 <open>
  ...
  if(chdir("dd") != 0){
    ...
    3800:	44c080e7          	jalr	1100(ra) # 5c48 <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3814:	438080e7          	jalr	1080(ra) # 5c48 <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3828:	424080e7          	jalr	1060(ra) # 5c48 <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    383c:	410080e7          	jalr	1040(ra) # 5c48 <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3852:	3ca080e7          	jalr	970(ra) # 5c18 <open>
    3856:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38a4:	378080e7          	jalr	888(ra) # 5c18 <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38bc:	360080e7          	jalr	864(ra) # 5c18 <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    38d4:	348080e7          	jalr	840(ra) # 5c18 <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    38ea:	332080e7          	jalr	818(ra) # 5c18 <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    3900:	31c080e7          	jalr	796(ra) # 5c18 <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    391c:	320080e7          	jalr	800(ra) # 5c38 <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3938:	304080e7          	jalr	772(ra) # 5c38 <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    3954:	2e8080e7          	jalr	744(ra) # 5c38 <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    3968:	2dc080e7          	jalr	732(ra) # 5c40 <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    397c:	2c8080e7          	jalr	712(ra) # 5c40 <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3990:	2b4080e7          	jalr	692(ra) # 5c40 <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    39a4:	288080e7          	jalr	648(ra) # 5c28 <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    39b8:	274080e7          	jalr	628(ra) # 5c28 <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    39cc:	280080e7          	jalr	640(ra) # 5c48 <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    39e0:	26c080e7          	jalr	620(ra) # 5c48 <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    39f4:	238080e7          	jalr	568(ra) # 5c28 <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    3a08:	224080e7          	jalr	548(ra) # 5c28 <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    3a1c:	210080e7          	jalr	528(ra) # 5c28 <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3a30:	1fc080e7          	jalr	508(ra) # 5c28 <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    3a44:	1e8080e7          	jalr	488(ra) # 5c28 <unlink>
...
0000000000003e64 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3e7c:	dc8080e7          	jalr	-568(ra) # 5c40 <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    3e8e:	dbe080e7          	jalr	-578(ra) # 5c48 <chdir>
  ...
  if(unlink(".") == 0){
    ...
    3ea0:	d8c080e7          	jalr	-628(ra) # 5c28 <unlink>
  ...
  if(unlink("..") == 0){
    ...
    3eb2:	d7a080e7          	jalr	-646(ra) # 5c28 <unlink>
  ...
  if(chdir("/") != 0){
    ...
    3ec4:	d88080e7          	jalr	-632(ra) # 5c48 <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    3ed6:	d56080e7          	jalr	-682(ra) # 5c28 <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    3ee8:	d44080e7          	jalr	-700(ra) # 5c28 <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    3efa:	d32080e7          	jalr	-718(ra) # 5c28 <unlink>
...
0000000000003fea <dirfile>:
{
  ...
  fd = open("dirfile/xx", 0);
    ...
    4038:	be4080e7          	jalr	-1052(ra) # 5c18 <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4050:	bcc080e7          	jalr	-1076(ra) # 5c18 <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    4064:	be0080e7          	jalr	-1056(ra) # 5c40 <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    4078:	bb4080e7          	jalr	-1100(ra) # 5c28 <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    4094:	ba8080e7          	jalr	-1112(ra) # 5c38 <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    40a8:	b84080e7          	jalr	-1148(ra) # 5c28 <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    40be:	b5e080e7          	jalr	-1186(ra) # 5c18 <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    40d4:	b48080e7          	jalr	-1208(ra) # 5c18 <open>
    40d8:	84aa                	mv	s1,a0
  if(write(fd, "x", 1) > 0){
    40da:	4605                	li	a2,1
    ...
    40e8:	b14080e7          	jalr	-1260(ra) # 5bf8 <write>
    40ec:	10a04b63          	bgtz	a0,4202 <dirfile+0x218>
  close(fd);
    40f0:	8526                	mv	a0,s1
    40f2:	00002097          	auipc	ra,0x2
    40f6:	b0e080e7          	jalr	-1266(ra) # 5c00 <close>
}
...
000000000000421e <iref>:
{
    ...
    4296:	96e080e7          	jalr	-1682(ra) # 5c00 <close>
    429a:	a889                	j	42ec <iref+0xce>
    unlink("xx");
    429c:	854e                	mv	a0,s3
    429e:	00002097          	auipc	ra,0x2
    42a2:	98a080e7          	jalr	-1654(ra) # 5c28 <unlink>
  for(i = 0; i < NINODE + 1; i++){
    ...
    42f6:	926080e7          	jalr	-1754(ra) # 5c18 <open>
    if(fd >= 0)
    42fa:	fa0541e3          	bltz	a0,429c <iref+0x7e>
      close(fd);
    42fe:	00002097          	auipc	ra,0x2
    4302:	902080e7          	jalr	-1790(ra) # 5c00 <close>
    ...
    4322:	92a080e7          	jalr	-1750(ra) # 5c48 <chdir>
    unlink("irefd");
    4326:	854a                	mv	a0,s2
    4328:	00002097          	auipc	ra,0x2
    432c:	900080e7          	jalr	-1792(ra) # 5c28 <unlink>
  for(i = 0; i < NINODE + 1; i++){
  ...
  chdir("/");
    ...
    4340:	90c080e7          	jalr	-1780(ra) # 5c48 <chdir>
}
...
0000000000004358 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    4370:	8d4080e7          	jalr	-1836(ra) # 5c40 <mkdir>
  ...
  if(pid == 0){
    ...
    4394:	888080e7          	jalr	-1912(ra) # 5c18 <open>
    if(fd >= 0){
...
000000000000444a <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    4462:	7ca080e7          	jalr	1994(ra) # 5c28 <unlink>
  int pid = fork();
  ...
  sleep(20); // two seconds
    ...
    447a:	7f2080e7          	jalr	2034(ra) # 5c68 <sleep>
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    448e:	78e080e7          	jalr	1934(ra) # 5c18 <open>
    4492:	00001097          	auipc	ra,0x1
    4496:	76e080e7          	jalr	1902(ra) # 5c00 <close>
  wait(0);
    449a:	4501                	li	a0,0
  ...
  sleep(10); // one second
    ...
    44aa:	7c2080e7          	jalr	1986(ra) # 5c68 <sleep>
}
    ...
    44e4:	738080e7          	jalr	1848(ra) # 5c18 <open>
      if(fd >= 0){
    ...
    4502:	71a080e7          	jalr	1818(ra) # 5c18 <open>
    4506:	00001097          	auipc	ra,0x1
    450a:	6fa080e7          	jalr	1786(ra) # 5c00 <close>
...
000000000000451a <killstatus>:
{
    ...
    4548:	724080e7          	jalr	1828(ra) # 5c68 <sleep>
    kill(pid1);
    454c:	8526                	mv	a0,s1
    454e:	00001097          	auipc	ra,0x1
    4552:	6ba080e7          	jalr	1722(ra) # 5c08 <kill>
    wait(&xst);
  ...
  exit(0);
    ...
    459a:	6c2080e7          	jalr	1730(ra) # 5c58 <getpid>
      while(1) {
...
00000000000045bc <preempt>:
{
  ...
  pipe(pfds);
    ...
    4632:	5ba080e7          	jalr	1466(ra) # 5be8 <pipe>
  pid3 = fork();
  ...
  if(pid3 == 0){
    ...
    464e:	5b6080e7          	jalr	1462(ra) # 5c00 <close>
  ...
  close(pfds[1]);
    ...
    46b4:	550080e7          	jalr	1360(ra) # 5c00 <close>
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    46ca:	52a080e7          	jalr	1322(ra) # 5bf0 <read>
    46ce:	4785                	li	a5,1
  ...
  close(pfds[0]);
    ...
    46fe:	506080e7          	jalr	1286(ra) # 5c00 <close>
  printf("kill... ");
  ...
  kill(pid1);
    ...
    4718:	4f4080e7          	jalr	1268(ra) # 5c08 <kill>
  kill(pid2);
    471c:	854e                	mv	a0,s3
    471e:	00001097          	auipc	ra,0x1
    4722:	4ea080e7          	jalr	1258(ra) # 5c08 <kill>
  kill(pid3);
    4726:	854a                	mv	a0,s2
    4728:	00001097          	auipc	ra,0x1
    472c:	4e0080e7          	jalr	1248(ra) # 5c08 <kill>
  printf("wait... ");
...
0000000000004760 <reparent>:
{
  ...
  int master_pid = getpid();
    ...
    4776:	4e6080e7          	jalr	1254(ra) # 5c58 <getpid>
    477a:	8a2a                	mv	s4,a0
  ...
  exit(0);
    ...
    4802:	40a080e7          	jalr	1034(ra) # 5c08 <kill>
        exit(1);
    4806:	4505                	li	a0,1
...
0000000000004810 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    482c:	3c0080e7          	jalr	960(ra) # 5be8 <pipe>
    ...
    4888:	374080e7          	jalr	884(ra) # 5bf8 <write>
      for(;;) sleep(1000);
    488c:	3e800513          	li	a0,1000
    4890:	00001097          	auipc	ra,0x1
    4894:	3d8080e7          	jalr	984(ra) # 5c68 <sleep>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    48e6:	326080e7          	jalr	806(ra) # 5c08 <kill>
    wait(0);
    48ea:	4501                	li	a0,0
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    4978:	2ec080e7          	jalr	748(ra) # 5c60 <sbrk>
    497c:	89aa                	mv	s3,a0
    sbrk(10*BIG);
    497e:	3e800537          	lui	a0,0x3e800
    4982:	00001097          	auipc	ra,0x1
    4986:	2de080e7          	jalr	734(ra) # 5c60 <sbrk>
...
0000000000004a6e <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    4a92:	19a080e7          	jalr	410(ra) # 5c28 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    ...
    4aa6:	176080e7          	jalr	374(ra) # 5c18 <open>
  if(fd < 0){
  ...
  memset(buf, pid==0?'c':'p', sizeof(buf));
    ...
    4ae2:	11a080e7          	jalr	282(ra) # 5bf8 <write>
    4ae6:	47a9                	li	a5,10
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4b90:	064080e7          	jalr	100(ra) # 5bf0 <read>
...
0000000000004c26 <fourfiles>:
{
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    4c8a:	fa2080e7          	jalr	-94(ra) # 5c28 <unlink>
    pid = fork();
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4d06:	f16080e7          	jalr	-234(ra) # 5c18 <open>
    4d0a:	892a                	mv	s2,a0
      if(fd < 0){
    ...
    4d3e:	ebe080e7          	jalr	-322(ra) # 5bf8 <write>
    4d42:	85aa                	mv	a1,a0
    ...
    4dc2:	e32080e7          	jalr	-462(ra) # 5bf0 <read>
    ...
    4df2:	e12080e7          	jalr	-494(ra) # 5c00 <close>
    if(total != N*SZ){
    4df6:	03a91963          	bne	s2,s10,4e28 <fourfiles+0x202>
    unlink(fname);
    4dfa:	8562                	mv	a0,s8
    4dfc:	00001097          	auipc	ra,0x1
    4e00:	e2c080e7          	jalr	-468(ra) # 5c28 <unlink>
  for(i = 0; i < NCHILD; i++){
    ...
    4e18:	e04080e7          	jalr	-508(ra) # 5c18 <open>
    4e1c:	89aa                	mv	s3,a0
    total = 0;
...
0000000000004e62 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4ea4:	d98080e7          	jalr	-616(ra) # 5c38 <link>
    if(pid == 0) {
    ...
    4ec2:	d5a080e7          	jalr	-678(ra) # 5c18 <open>
      if(fd < 0){
    ...
    4ef8:	d44080e7          	jalr	-700(ra) # 5c38 <link>
      exit(0);
    4efc:	4501                	li	a0,0
  ...
  fd = open(".", 0);
    ...
    4f30:	cec080e7          	jalr	-788(ra) # 5c18 <open>
    4f34:	892a                	mv	s2,a0
  n = 0;
    4f36:	8aa6                	mv	s5,s1
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4f7c:	c78080e7          	jalr	-904(ra) # 5bf0 <read>
  ...
  close(fd);
    ...
    4fda:	c2a080e7          	jalr	-982(ra) # 5c00 <close>
  if(n != N){
  ...
  for(i = 0; i < N; i++){
    ...
    5032:	bea080e7          	jalr	-1046(ra) # 5c18 <open>
    5036:	00001097          	auipc	ra,0x1
    503a:	bca080e7          	jalr	-1078(ra) # 5c00 <close>
      close(open(file, 0));
    503e:	4581                	li	a1,0
    5040:	fa840513          	addi	a0,s0,-88
    5044:	00001097          	auipc	ra,0x1
    5048:	bd4080e7          	jalr	-1068(ra) # 5c18 <open>
    504c:	00001097          	auipc	ra,0x1
    5050:	bb4080e7          	jalr	-1100(ra) # 5c00 <close>
      close(open(file, 0));
    5054:	4581                	li	a1,0
    5056:	fa840513          	addi	a0,s0,-88
    505a:	00001097          	auipc	ra,0x1
    505e:	bbe080e7          	jalr	-1090(ra) # 5c18 <open>
    5062:	00001097          	auipc	ra,0x1
    5066:	b9e080e7          	jalr	-1122(ra) # 5c00 <close>
      close(open(file, 0));
    506a:	4581                	li	a1,0
    506c:	fa840513          	addi	a0,s0,-88
    5070:	00001097          	auipc	ra,0x1
    5074:	ba8080e7          	jalr	-1112(ra) # 5c18 <open>
    5078:	00001097          	auipc	ra,0x1
    507c:	b88080e7          	jalr	-1144(ra) # 5c00 <close>
      close(open(file, 0));
    5080:	4581                	li	a1,0
    5082:	fa840513          	addi	a0,s0,-88
    5086:	00001097          	auipc	ra,0x1
    508a:	b92080e7          	jalr	-1134(ra) # 5c18 <open>
    508e:	00001097          	auipc	ra,0x1
    5092:	b72080e7          	jalr	-1166(ra) # 5c00 <close>
      close(open(file, 0));
    5096:	4581                	li	a1,0
    5098:	fa840513          	addi	a0,s0,-88
    509c:	00001097          	auipc	ra,0x1
    50a0:	b7c080e7          	jalr	-1156(ra) # 5c18 <open>
    50a4:	00001097          	auipc	ra,0x1
    50a8:	b5c080e7          	jalr	-1188(ra) # 5c00 <close>
    if(pid == 0)
  ...
  for(i = 0; i < N; i++){
    ...
    5140:	ac4080e7          	jalr	-1340(ra) # 5c00 <close>
    if(pid == 0) {
    5144:	bb65                	j	4efc <concreate+0x9a>
      close(fd);
    5146:	00001097          	auipc	ra,0x1
    514a:	aba080e7          	jalr	-1350(ra) # 5c00 <close>
      wait(&xstatus);
  ...
  for(i = 0; i < N; i++){
    ...
    5178:	ab4080e7          	jalr	-1356(ra) # 5c28 <unlink>
    pid = fork();
    ...
    519c:	a80080e7          	jalr	-1408(ra) # 5c18 <open>
      if(fd < 0){
...
00000000000051bc <bigfile>:
{
  ...
  unlink("bigfile.dat");
    ...
    51dc:	a50080e7          	jalr	-1456(ra) # 5c28 <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    ...
    51f0:	a2c080e7          	jalr	-1492(ra) # 5c18 <open>
    51f4:	89aa                	mv	s3,a0
  for(i = 0; i < N; i++){
    51f6:	4481                	li	s1,0
    memset(buf, i, SZ);
  ...
  if(fd < 0){
    ...
    5222:	9da080e7          	jalr	-1574(ra) # 5bf8 <write>
  ...
  if(fd < 0){
    ...
    526e:	986080e7          	jalr	-1658(ra) # 5bf0 <read>
    if(cc < 0){
  ...
  close(fd);
    ...
    5350:	8b4080e7          	jalr	-1868(ra) # 5c00 <close>
  if(total != N*SZ){
  ...
  unlink("bigfile.dat");
    ...
    536a:	8c2080e7          	jalr	-1854(ra) # 5c28 <unlink>
}
...
000000000000539c <fsfull>:
{
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    5446:	7d6080e7          	jalr	2006(ra) # 5c18 <open>
    544a:	892a                	mv	s2,a0
    if(fd < 0){
  ...
  while(nfiles >= 0){
    ...
    54c0:	76c080e7          	jalr	1900(ra) # 5c28 <unlink>
    nfiles--;
  ...
  printf("fsfull test finished\n");
    ...
    550a:	6f2080e7          	jalr	1778(ra) # 5bf8 <write>
      if(cc < BSIZE)
    ...
    5530:	6d4080e7          	jalr	1748(ra) # 5c00 <close>
    if(total == 0)
...
countfree()
{
  ...
  if(pipe(fds) < 0){
    ...
    564c:	5a0080e7          	jalr	1440(ra) # 5be8 <pipe>
  ...
  if(pid == 0){
    ...
    566a:	59a080e7          	jalr	1434(ra) # 5c00 <close>
    ...
    5680:	5e4080e7          	jalr	1508(ra) # 5c60 <sbrk>
      if(a == 0xffffffffffffffff){
    ...
    569c:	560080e7          	jalr	1376(ra) # 5bf8 <write>
    56a0:	4785                	li	a5,1
  ...
  close(fds[1]);
    ...
    5706:	4fe080e7          	jalr	1278(ra) # 5c00 <close>
  ...
  while(1){
    ...
    571a:	4da080e7          	jalr	1242(ra) # 5bf0 <read>
    if(cc < 0){
  ...
  close(fds[0]);
    ...
    574a:	4ba080e7          	jalr	1210(ra) # 5c00 <close>
  wait((int*)0);
    574e:	4501                	li	a0,0
...
gets(char *buf, int max)
{
  ...
  for(i=0; i+1 < max; ){
    ...
    5a4c:	1a8080e7          	jalr	424(ra) # 5bf0 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    5a9e:	17e080e7          	jalr	382(ra) # 5c18 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
    ...
    5aae:	186080e7          	jalr	390(ra) # 5c30 <fstat>
    5ab2:	892a                	mv	s2,a0
  close(fd);
    5ab4:	8526                	mv	a0,s1
    5ab6:	00000097          	auipc	ra,0x0
    5aba:	14a080e7          	jalr	330(ra) # 5c00 <close>
  return r;
}
    5abe:	854a                	mv	a0,s2
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
    ...
    5c8e:	f6e080e7          	jalr	-146(ra) # 5bf8 <write>
}
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    60e6:	b7e080e7          	jalr	-1154(ra) # 5c60 <sbrk>
  if(p == (char*)-1)
