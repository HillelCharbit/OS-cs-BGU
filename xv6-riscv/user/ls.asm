...
ls(char *path)
{
  ...
  de:	4d6080e7          	jalr	1238(ra) # 5b0 <open>
  ...
  f0:	4dc080e7          	jalr	1244(ra) # 5c8 <fstat>
 ...
 13e:	45e080e7          	jalr	1118(ra) # 598 <close>
}
 ...
 194:	408080e7          	jalr	1032(ra) # 598 <close>
    return;
 ...
 220:	36c080e7          	jalr	876(ra) # 588 <read>
 224:	47c1                	li	a5,16
...
gets(char *buf, int max)
{
 ...
 3e4:	1a8080e7          	jalr	424(ra) # 588 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 436:	17e080e7          	jalr	382(ra) # 5b0 <open>
  if(fd < 0)
 ...
 446:	186080e7          	jalr	390(ra) # 5c8 <fstat>
 44a:	892a                	mv	s2,a0
  close(fd);
 44c:	8526                	mv	a0,s1
 44e:	00000097          	auipc	ra,0x0
 452:	14a080e7          	jalr	330(ra) # 598 <close>
  return r;
}
 456:	854a                	mv	a0,s2
...
putc(int fd, char c)
{
 ...
 626:	f6e080e7          	jalr	-146(ra) # 590 <write>
}
...
malloc(uint nbytes)
{
 ...
 a7e:	b7e080e7          	jalr	-1154(ra) # 5f8 <sbrk>
  if(p == (char*)-1)
