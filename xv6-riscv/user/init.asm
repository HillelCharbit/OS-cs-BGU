...
main(void)
{
  ...
  1a:	3ba080e7          	jalr	954(ra) # 3d0 <open>
  ...
  28:	3e4080e7          	jalr	996(ra) # 408 <dup>
  dup(0);  // stderr
  2c:	4501                	li	a0,0
  2e:	00000097          	auipc	ra,0x0
  32:	3da080e7          	jalr	986(ra) # 408 <dup>
  ...
  94:	348080e7          	jalr	840(ra) # 3d8 <mknod>
    open("console", O_RDWR);
  98:	4589                	li	a1,2
  9a:	00001517          	auipc	a0,0x1
  9e:	81650513          	addi	a0,a0,-2026 # 8b0 <malloc+0xea>
  a2:	00000097          	auipc	ra,0x0
  a6:	32e080e7          	jalr	814(ra) # 3d0 <open>
  ...
  da:	2f2080e7          	jalr	754(ra) # 3c8 <exec>
...
gets(char *buf, int max)
{
 ...
 204:	1a8080e7          	jalr	424(ra) # 3a8 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 256:	17e080e7          	jalr	382(ra) # 3d0 <open>
  if(fd < 0)
 ...
 266:	186080e7          	jalr	390(ra) # 3e8 <fstat>
 26a:	892a                	mv	s2,a0
  close(fd);
 26c:	8526                	mv	a0,s1
 26e:	00000097          	auipc	ra,0x0
 272:	14a080e7          	jalr	330(ra) # 3b8 <close>
  return r;
}
 276:	854a                	mv	a0,s2
...
putc(int fd, char c)
{
 ...
 446:	f6e080e7          	jalr	-146(ra) # 3b0 <write>
}
...
malloc(uint nbytes)
{
 ...
 89e:	b7e080e7          	jalr	-1154(ra) # 418 <sbrk>
  if(p == (char*)-1)
