...
main(int argc, char *argv[])
{
  ...
  36:	326080e7          	jalr	806(ra) # 358 <link>
...
gets(char *buf, int max)
{
 ...
 16c:	1a8080e7          	jalr	424(ra) # 310 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1be:	17e080e7          	jalr	382(ra) # 338 <open>
  if(fd < 0)
 ...
 1ce:	186080e7          	jalr	390(ra) # 350 <fstat>
 1d2:	892a                	mv	s2,a0
  close(fd);
 1d4:	8526                	mv	a0,s1
 1d6:	00000097          	auipc	ra,0x0
 1da:	14a080e7          	jalr	330(ra) # 320 <close>
  return r;
}
 1de:	854a                	mv	a0,s2
