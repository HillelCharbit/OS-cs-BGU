...
wc(int fd, char *name)
{
  ...
  86:	3cc080e7          	jalr	972(ra) # 44e <read>
...
main(int argc, char *argv[])
{
 ...
 130:	34a080e7          	jalr	842(ra) # 476 <open>
 134:	892a                	mv	s2,a0
 ...
 14a:	318080e7          	jalr	792(ra) # 45e <close>
  for(i = 1; i < argc; i++){
...
gets(char *buf, int max)
{
 ...
 2a2:	1b0080e7          	jalr	432(ra) # 44e <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2f4:	186080e7          	jalr	390(ra) # 476 <open>
  if(fd < 0)
 ...
 304:	18e080e7          	jalr	398(ra) # 48e <fstat>
 308:	892a                	mv	s2,a0
  close(fd);
 30a:	8526                	mv	a0,s1
 30c:	00000097          	auipc	ra,0x0
 310:	152080e7          	jalr	338(ra) # 45e <close>
  return r;
}
 314:	854a                	mv	a0,s2
