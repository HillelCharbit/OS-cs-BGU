...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      20:	df2080e7          	jalr	-526(ra) # e0e <write>
  memset(buf, 0, nbuf);
      24:	864a                	mv	a2,s2
      26:	4581                	li	a1,0
      28:	8526                	mv	a0,s1
...
00000000000000aa <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    exec(ecmd->argv[0], ecmd->argv);
      ...
      fc:	d2e080e7          	jalr	-722(ra) # e26 <exec>
  ...
  exit(0);
    ...
    close(rcmd->fd);
     ...
     12e:	cec080e7          	jalr	-788(ra) # e16 <close>
    if(open(rcmd->file, rcmd->mode) < 0){
     132:	508c                	lw	a1,32(s1)
     134:	6888                	ld	a0,16(s1)
     136:	00001097          	auipc	ra,0x1
     13a:	cf8080e7          	jalr	-776(ra) # e2e <open>
    ...
    if(pipe(p) < 0)
     ...
     19a:	c68080e7          	jalr	-920(ra) # dfe <pipe>
    ...
    if(fork1() == 0){
     ...
     1b2:	c68080e7          	jalr	-920(ra) # e16 <close>
      dup(p[1]);
     1b6:	fdc42503          	lw	a0,-36(s0)
     1ba:	00001097          	auipc	ra,0x1
     1be:	cac080e7          	jalr	-852(ra) # e66 <dup>
      close(p[0]);
     1c2:	fd842503          	lw	a0,-40(s0)
     1c6:	00001097          	auipc	ra,0x1
     1ca:	c50080e7          	jalr	-944(ra) # e16 <close>
      close(p[1]);
     1ce:	fdc42503          	lw	a0,-36(s0)
     1d2:	00001097          	auipc	ra,0x1
     1d6:	c44080e7          	jalr	-956(ra) # e16 <close>
      runcmd(pcmd->left);
     1da:	6488                	ld	a0,8(s1)
    ...
    if(fork1() == 0){
     ...
     202:	c18080e7          	jalr	-1000(ra) # e16 <close>
      dup(p[0]);
     206:	fd842503          	lw	a0,-40(s0)
     20a:	00001097          	auipc	ra,0x1
     20e:	c5c080e7          	jalr	-932(ra) # e66 <dup>
      close(p[0]);
     212:	fd842503          	lw	a0,-40(s0)
     216:	00001097          	auipc	ra,0x1
     21a:	c00080e7          	jalr	-1024(ra) # e16 <close>
      close(p[1]);
     21e:	fdc42503          	lw	a0,-36(s0)
     222:	00001097          	auipc	ra,0x1
     226:	bf4080e7          	jalr	-1036(ra) # e16 <close>
      runcmd(pcmd->right);
    ...
    close(p[0]);
     ...
     23c:	bde080e7          	jalr	-1058(ra) # e16 <close>
    close(p[1]);
     240:	fdc42503          	lw	a0,-36(s0)
     244:	00001097          	auipc	ra,0x1
     248:	bd2080e7          	jalr	-1070(ra) # e16 <close>
    wait(0);
     24c:	4501                	li	a0,0
...
0000000000000a62 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a84:	3ae080e7          	jalr	942(ra) # e2e <open>
    ...
    if(fd >= 3){
     ...
     a96:	384080e7          	jalr	900(ra) # e16 <close>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b1c:	346080e7          	jalr	838(ra) # e5e <chdir>
...
gets(char *buf, int max)
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     c62:	1a8080e7          	jalr	424(ra) # e06 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     cb4:	17e080e7          	jalr	382(ra) # e2e <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     cc4:	186080e7          	jalr	390(ra) # e46 <fstat>
     cc8:	892a                	mv	s2,a0
  close(fd);
     cca:	8526                	mv	a0,s1
     ccc:	00000097          	auipc	ra,0x0
     cd0:	14a080e7          	jalr	330(ra) # e16 <close>
  return r;
}
     cd4:	854a                	mv	a0,s2
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     ea4:	f6e080e7          	jalr	-146(ra) # e0e <write>
}
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12fc:	b7e080e7          	jalr	-1154(ra) # e76 <sbrk>
  if(p == (char*)-1)
