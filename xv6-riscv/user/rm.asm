...
gets(char *buf, int max)
{
 ...
 184:	1b0080e7          	jalr	432(ra) # 330 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1d6:	186080e7          	jalr	390(ra) # 358 <open>
  if(fd < 0)
 ...
 1e6:	18e080e7          	jalr	398(ra) # 370 <fstat>
 1ea:	892a                	mv	s2,a0
  close(fd);
 1ec:	8526                	mv	a0,s1
 1ee:	00000097          	auipc	ra,0x0
 1f2:	152080e7          	jalr	338(ra) # 340 <close>
  return r;
}
 1f6:	854a                	mv	a0,s2
...
malloc(uint nbytes)
{
 ...
 826:	b7e080e7          	jalr	-1154(ra) # 3a0 <sbrk>
  if(p == (char*)-1)
