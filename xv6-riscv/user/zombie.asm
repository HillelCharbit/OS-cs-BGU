...
gets(char *buf, int max)
{
 ...
 136:	1b0080e7          	jalr	432(ra) # 2e2 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 188:	186080e7          	jalr	390(ra) # 30a <open>
  if(fd < 0)
 ...
 198:	18e080e7          	jalr	398(ra) # 322 <fstat>
 19c:	892a                	mv	s2,a0
  close(fd);
 19e:	8526                	mv	a0,s1
 1a0:	00000097          	auipc	ra,0x0
 1a4:	152080e7          	jalr	338(ra) # 2f2 <close>
  return r;
}
 1a8:	854a                	mv	a0,s2
