...
000000000000011a <grep>:
{
 ...
 164:	406080e7          	jalr	1030(ra) # 566 <write>
      p = q+1;
 ...
 1a2:	3c0080e7          	jalr	960(ra) # 55e <read>
...
00000000000001ee <main>:
{
 ...
 22e:	35c080e7          	jalr	860(ra) # 586 <open>
 232:	84aa                	mv	s1,a0
 ...
 24a:	328080e7          	jalr	808(ra) # 56e <close>
  for(i = 2; i < argc; i++){
...
gets(char *buf, int max)
{
 ...
 3ba:	1a8080e7          	jalr	424(ra) # 55e <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 40c:	17e080e7          	jalr	382(ra) # 586 <open>
  if(fd < 0)
 ...
 41c:	186080e7          	jalr	390(ra) # 59e <fstat>
 420:	892a                	mv	s2,a0
  close(fd);
 422:	8526                	mv	a0,s1
 424:	00000097          	auipc	ra,0x0
 428:	14a080e7          	jalr	330(ra) # 56e <close>
  return r;
}
 42c:	854a                	mv	a0,s2
...
putc(int fd, char c)
{
 ...
 5fc:	f6e080e7          	jalr	-146(ra) # 566 <write>
}
...
malloc(uint nbytes)
{
 ...
 a54:	b7e080e7          	jalr	-1154(ra) # 5ce <sbrk>
  if(p == (char*)-1)
