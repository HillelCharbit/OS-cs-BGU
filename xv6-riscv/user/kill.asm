...
main(int argc, char **argv)
{
  ...
  34:	2fc080e7          	jalr	764(ra) # 32c <kill>
  for(i=1; i<argc; i++)
...
gets(char *buf, int max)
{
 ...
 170:	1a8080e7          	jalr	424(ra) # 314 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1c2:	17e080e7          	jalr	382(ra) # 33c <open>
  if(fd < 0)
 ...
 1d2:	186080e7          	jalr	390(ra) # 354 <fstat>
 1d6:	892a                	mv	s2,a0
  close(fd);
 1d8:	8526                	mv	a0,s1
 1da:	00000097          	auipc	ra,0x0
 1de:	14a080e7          	jalr	330(ra) # 324 <close>
  return r;
}
 1e2:	854a                	mv	a0,s2
