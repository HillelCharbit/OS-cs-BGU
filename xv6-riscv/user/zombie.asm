...
gets(char *buf, int max)
{
 ...
 136:	1a8080e7          	jalr	424(ra) # 2da <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 188:	17e080e7          	jalr	382(ra) # 302 <open>
  if(fd < 0)
 ...
 198:	186080e7          	jalr	390(ra) # 31a <fstat>
 19c:	892a                	mv	s2,a0
  close(fd);
 19e:	8526                	mv	a0,s1
 1a0:	00000097          	auipc	ra,0x0
 1a4:	14a080e7          	jalr	330(ra) # 2ea <close>
  return r;
}
 1a8:	854a                	mv	a0,s2
...
malloc(uint nbytes)
{
 ...
 7d0:	b7e080e7          	jalr	-1154(ra) # 34a <sbrk>
  if(p == (char*)-1)
